      ...
      <div className="relative z-10 max-h-[92vh] w-full max-w-xl overflow-y-auto rounded-2xl border border-slate-200 bg-white shadow-2xl">
        <div className="flex items-start justify-between border-b border-slate-200 px-6 py-5">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Find the exact Google Maps
              location before creating scans.
            </p>
          </div>
        ...
        >
          <FormField
            ...
            placeholder="Sliding Door Repair Fort Myers"
            onChange={(value) =>
              updateField(
                "businessName",
                value,
          ...
          <FormField
            ...
            value={form.category}
            placeholder="Door repair service"
            onChange={(value) =>
              updateField(
                "category",
                value,
          ...
          <div className="flex items-start gap-3 rounded-xl bg-slate-50 p-4">
            ...
            <p className="text-xs leading-5 text-slate-500">
              Use the Share link from the
              exact Google Maps business
              listing. The scanner grid will
              use the confirmed coordinates.
            </p>
          </div>
