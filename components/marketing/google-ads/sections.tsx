...
<MobileNavigation />
<Link href={LOGIN_URL} className="text-sm font-semibold text-slate-600 hover:text-[#0b1329] px-3 py-2 transition" prefetch={false}>
          Log In
        </Link>
<Link href={SIGNUP_URL} className="inline-flex items-center justify-center gap-1.5 px-4 py-2 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 active:scale-95 rounded-lg shadow-sm shadow-blue-600/30 transition-all" prefetch={false}>
...
<Link href={SIGNUP_URL} className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 text-base font-bold text-white bg-blue-600 hover:bg-blue-700 active:scale-[0.98] rounded-xl shadow-lg shadow-blue-600/25 hover:shadow-blue-600/35 transition-all group" prefetch={false}>
...
<div className="pt-4">
<Link href={SIGNUP_URL} className="inline-flex items-center gap-2 px-6 py-3 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 active:scale-95 rounded-xl shadow-md shadow-blue-600/20 transition" prefetch={false}>
...
<span className="text-slate-400 font-normal">| 25 Coordinates</span>
</div>
...
<span>Avg Rank: <strong className="text-blue-400 font-mono">5.7</strong></span>
<span>•</span>
<span>Visibility: <strong className="text-emerald-400 font-mono">84%</strong></span>
</div>
</div>
</div>
</div>
...
<span className="font-bold text-slate-800">Your business</span>
<span className="text-slate-400 font-semibold text-[11px] bg-slate-100 px-2 py-0.5 rounded">Rank at each point</span>
</div>
...
<div className="text-emerald-400 font-bold">Selected point: rank #4</div>
<div className="text-slate-300 text-[11px]">Every business Google Maps showed there, in order</div>
</div>
</div>
</div>
...
<span className="text-[10px] uppercase font-bold text-amber-600 bg-amber-50 px-2 py-0.5 rounded border border-amber-200">Example</span>
</div>
...
<div className="pt-2">
<Link href={SIGNUP_URL} className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-bold text-[#0b1329] bg-amber-400 hover:bg-amber-300 rounded-xl transition shadow-sm" prefetch={false}>
...
<Link href={SIGNUP_URL} className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl transition shadow-sm" prefetch={false}>
...
<Link className="text-indigo-400 hover:text-indigo-300 font-semibold inline-flex items-center gap-1" href={SIGNUP_URL} prefetch={false}>
<span>Explore AI Reports</span>
...
<div className="pt-4">
<Link href={SIGNUP_URL} className="inline-flex items-center gap-2 px-6 py-3.5 text-sm font-bold text-[#0b1329] bg-blue-400 hover:bg-blue-300 rounded-xl transition shadow-lg shadow-blue-400/20" prefetch={false}>
